...
#ifndef TYZEN_WALLET_TRANSACTION_H
#define TYZEN_WALLET_TRANSACTION_H
...
public:
     ...
     * on this tyzen node, and set to 0 for transactions that were created
...
#endif // TYZEN_WALLET_TRANSACTION_H
