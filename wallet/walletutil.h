...
#ifndef TYZEN_WALLET_WALLETUTIL_H
#define TYZEN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! tyzen from opening the wallet, thinking it was newly created, and
...
#endif // TYZEN_WALLET_WALLETUTIL_H
