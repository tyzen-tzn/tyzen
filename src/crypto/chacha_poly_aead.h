...
#ifndef TYZEN_CRYPTO_CHACHA_POLY_AEAD_H
#define TYZEN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@tyzen.
 *
 ...
 *
 * The chacha20-poly1305@tyzen combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@tyzen cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@tyzen are relatively fast in
...
#endif // TYZEN_CRYPTO_CHACHA_POLY_AEAD_H
