...
#ifndef TYZEN_UTIL_SYSCALL_SANDBOX_H
#define TYZEN_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during tyzend initialization if Tyzen Core was compiled
...
#endif // TYZEN_UTIL_SYSCALL_SANDBOX_H
