 ...
 */
#ifndef TYZEN_UTIL_SYSTEM_H
#define TYZEN_UTIL_SYSTEM_H
...
extern const char * const TYZEN_CONF_FILENAME;
extern const char * const TYZEN_SETTINGS_FILENAME;
