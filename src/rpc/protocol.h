...
#ifndef TYZEN_RPC_PROTOCOL_H
#define TYZEN_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in tyzend
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Tyzen is not connected
