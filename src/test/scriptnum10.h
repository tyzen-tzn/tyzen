...
#ifndef TYZEN_TEST_SCRIPTNUM10_H
#define TYZEN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Tyzen Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // TYZEN_TEST_SCRIPTNUM10_H
