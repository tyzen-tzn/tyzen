 ...
 * src/qt/guiutil.cpp and src/tyzen-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Tyzen’s Peer-to-Peer Network")
...
public:
     ...
     * @see https://github.com/tyzen/tyzen/issues/21744 for details.
     */
