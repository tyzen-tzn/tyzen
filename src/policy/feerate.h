...
#ifndef TYZEN_POLICY_FEERATE_H
#define TYZEN_POLICY_FEERATE_H
...
const std::string CURRENCY_UNIT = "TZN"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    TZN_KVB,      //!< Use TZN/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::TZN_KVB) const;

    SERIALIZE_METHODS(CFeeRate, obj) { READWRITE(obj.nSatoshisPerK); }
};

#endif // TYZEN_POLICY_FEERATE_H
