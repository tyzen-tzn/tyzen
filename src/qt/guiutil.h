...
#ifndef TYZEN_QT_GUIUTIL_H
#define TYZEN_QT_GUIUTIL_H
...
/** Utility functions used by the Tyzen Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "tyzen:" URI into recipient object, return true on successful parsing
