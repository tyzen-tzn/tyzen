...
void AppTests::appTests()
{
    ...
    connect(&m_app, &TyzenApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for TyzenGUI tests.
void AppTests::guiTests(TyzenGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &TyzenGUI::consoleShown, this, &AppTests::consoleTests);
