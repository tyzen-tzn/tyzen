// Copyright (c) 2018 The Bitcoin and Tyzen Core Authors
...
//! Entry point for TyzenApplication tests.
void OptionTests::optionTests()
{
    // Test regression https://github.com/tyzen/tyzen/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/tyzen-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/tyzen-core/gui/pull/568.
    // With fListen=false in ~/.config/Tyzen/Tyzen-Qt.conf and all else left as default,
    // tyzen-qt should set both -listen and -listenonion to false and start successfully.
