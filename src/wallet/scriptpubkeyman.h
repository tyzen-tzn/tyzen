...
#ifndef TYZEN_WALLET_SCRIPTPUBKEYMAN_H
#define TYZEN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Tyzen Core wallet was originally a collection of unrelated private
...
#endif // TYZEN_WALLET_SCRIPTPUBKEYMAN_H
