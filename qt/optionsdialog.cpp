    ...
    mapper(nullptr)
{
    ...
    ui->tyzenAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->tyzenAtStartup);
    ...
    ui->tyzenAtStartup->setToolTip(ui->tyzenAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->tyzenAtStartup->setText(ui->tyzenAtStartup->text().arg(PACKAGE_NAME));

    ui->openTyzenConfButton->setToolTip(ui->openTyzenConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new TyzenUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->tyzenAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSTZNontrols);
...
void OptionsDialog::on_openTyzenConfButton_clicked()
{
