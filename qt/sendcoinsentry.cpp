    ...
    platformStyle(_platformStyle)
{
    ...
    // normal tyzen address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying tyzen address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &TyzenAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
