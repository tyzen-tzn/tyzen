...
class TxnMallTest(TyzenTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 TZN:
        ...
        # First: use raw transaction API to send 1240 TZN to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 TZN coin each
        ...
        # Node0's balance should be starting balance, plus 50TZN for another
        ...
        # Node0's total balance should be starting balance, plus 100TZN for
