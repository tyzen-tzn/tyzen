...
"""Verify that starting tyzen with -h works as expected."""

from test_framework.test_framework import TyzenTestFramework
from test_framework.util import assert_equal

class HelpTest(TyzenTestFramework):
    ...
    def run_test(self):
        self.log.info("Start tyzen with -h for help text")
        ...
        self.log.info("Start tyzen with -version for version information")
        ...
        self.log.info("Start tyzend with -fakearg to make sure it does not start")
