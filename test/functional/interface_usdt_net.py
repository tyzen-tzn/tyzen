...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/tyzen/tyzen/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(TyzenTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our tyzend node")
