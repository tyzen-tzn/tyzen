...
class P2PPermissionsTests(TyzenTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].tyzenconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].tyzenconf, 'w', encoding="utf8") as f:
            f.write(newText)
