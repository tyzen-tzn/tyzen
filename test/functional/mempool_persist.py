...
By default, tyzend will dump mempool on shutdown and
...
class MempoolPersistTest(TyzenTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent tyzend from writing mempool.dat to disk. Verify that `savemempool` fails")
