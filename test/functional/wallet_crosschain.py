...
class WalletCrossChain(TyzenTestFramework):
    ...
    def setup_network(self):
        ...
        with open(self.nodes[1].tyzenconf, 'r', encoding='utf8') as conf:
            conf_data = conf.read()
        with open (self.nodes[1].tyzenconf, 'w', encoding='utf8') as conf:
