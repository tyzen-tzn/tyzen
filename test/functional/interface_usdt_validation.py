...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/tyzen/tyzen/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(TyzenTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/tyzen/tyzen/blob/master/doc/tracing.md#tracepoint-validationblock_connected
