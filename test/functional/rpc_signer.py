...
Verify that a tyzend node can use an external signer command.
...
class RPCSignerTest(TyzenTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart tyzend with -signer=<cmd>',
