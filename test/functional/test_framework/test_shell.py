...
class TestShell:
    """Wrapper Class for TyzenTestFramework.

    The TestShell class extends the TyzenTestFramework
    ...
    class __TestShell(TyzenTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by TyzenTestFramework child class.
            self.num_nodes = 1
