...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the TyzenTestFramework
    pass


class ExampleTest(TyzenTestFramework):
    # Each functional test is a subclass of the TyzenTestFramework class.
    ...
    def custom_method(self):
        ...
        TyzenTestFramework class so other tests can use it."""
