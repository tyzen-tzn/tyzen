...
#ifndef TYZEN_SCRIPT_STANDARD_H
#define TYZEN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a tyzen address
 */
...
/**
 * Generate a Tyzen scriptPubKey for the given CTxDestination. Returns a P2PKH
