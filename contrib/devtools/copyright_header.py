...
EXPECTED_HOLDER_NAMES = [
    r"Satoshi Nakamoto",
    r"The Bitcoin and Tyzen Core Authors",
    r"BitPay Inc\.",
...
Arguments:
    <base_directory> - The base directory of a tyzen source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Bitcoin and Tyzen Core Authors'
...
CPP_HEADER = '''
// Copyright (c) %s The Bitcoin and Tyzen Core Authors
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.
'''
...
def exec_insert_header(filename, style):
    ...
    if file_already_has_core_copyright(file_lines):
        sys.exit('*** %s already has a copyright by The Bitcoin and Tyzen Core Authors'
                 % (filename))
...
Arguments:
    <file> - A source file in the tyzen repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Tyzen
