...
"""Example logging Tyzen Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/tyzend
...
def main(tyzend_path):
    ...
    b = BPF(text=program, usdt_contexts=[tyzend_with_usdts])
