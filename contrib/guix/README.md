# Bootstrappable Tyzen Core Builds

This directory contains the files necessary to perform bootstrappable Tyzen
Core builds.
...
To build Tyzen Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Tyzen Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/tyzen-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/tyzen-core/guix.sigs).
