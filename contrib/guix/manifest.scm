...
(define* (make-tyzen-cross-toolchain target
                                       #:key
...
desirable for building Tyzen Core release binaries."
...
(define-public glibc-2.27/tyzen-patched
  (package
    (inherit glibc-2.31)
    (version "2.27")
    (source (origin
          ...
          ((string-contains target "-linux-")
           (list ;; Native GCC 7 toolchain
                 ...
                 (cond ((string-contains target "riscv64-")
                        (make-tyzen-cross-toolchain target
                                                      #:base-libc glibc-2.27/tyzen-patched
