...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef TYZEN_CHAINPARAMSSEEDS_H\n')
    g.write('#define TYZEN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the tyzen network\n')
    ...
    g.write('#endif // TYZEN_CHAINPARAMSSEEDS_H\n')
