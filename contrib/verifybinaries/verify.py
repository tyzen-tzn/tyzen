...
"""Script for verifying Tyzen Core release binaries

This script attempts to download the signature file SHA256SUMS.asc from
tyzencore.org and tyzen.io and compares them.
...
WORKINGDIR = "/tmp/tyzen_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://tyzencore.org"
HOST2 = "https://www.tyzen.io"
VERSIONPREFIX = "tyzen-core-"
...
def main(args):
    ...
    if not success:
        print("tyzen.io failed to provide signature file, "
              "but tyzencore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("tyzen.io and tyzencore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Tyzen Core binary release "
