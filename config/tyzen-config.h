/* src/config/tyzen-config.h.  Generated from tyzen-config.h.in by configure.  */
/* src/config/tyzen-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef TYZEN_CONFIG_H

#define TYZEN_CONFIG_H
...
/* Minor version */
#define CLIENT_VERSION_MINOR 100

/* Copyright holder(s) before %s replacement */
#define COPYRIGHT_HOLDERS "The %s developers"

/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Tyzen Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Tyzen Core"
...
#define PACKAGE_BUGREPORT "https://github.com/tyzen-tzn/tyzen/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Tyzen Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Tyzen Core 23.100.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "tyzen"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://www.tyzen.io/"

/* Define to the version of this package. */
#define PACKAGE_VERSION "23.100.0"
