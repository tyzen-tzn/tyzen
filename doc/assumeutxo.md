...
Assumeutxo is a feature that allows fast bootstrapping of a validating tyzend
...
- [Github issue](https://github.com/tyzen/tyzen/issues/15605)
- [draft PR](https://github.com/tyzen/tyzen/pull/15606)
...
considered active. This is the "traditional" mode of operation for tyzend.
...
**Failure consideration:** if tyzend unexpectedly halts after `m_stop_use` is set on
...
### Tyzend restarts sometime after snapshot validation has completed

When tyzend initializes again, what began as the snapshot chainstate is now
