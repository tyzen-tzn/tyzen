Tyzen Core version 1.0.0 is now available from:

  <https://www.tyzen.io/downloads/tyzen-1.0.0/>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/tyzen-tzn/tyzen/issues>

To receive security and update notifications, please subscribe to:

  <https://groups.google.com/forum/#!forum/tyzen-dev>
...
Tyzen Core now supports P2SH addresses beginning with M on mainnet and Q on testnet.
...
This only affects users that have explicitly enabled UPnP through the GUI setting or through the -upnp option, as since the last UPnP vulnerability (in Tyzen Core 1.0.0) it has been disabled by default.
...
- http://testnet.tyzentools.com
- http://testnet.thrasher.io

Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/tyzen-tzn/tyzen/blob/master/src/chainparams.cpp#L220).
...
Tyzen Core has supported automatically pruning the blockchain since 0.13.2. Pruning
...
now ZMQ can be used on Windows. Please see [this document](https://github.com/tyzen-tzn/tyzen/blob/master/doc/zmq.md) for
...
The Alert System was disabled and deprecated in Tyzen Core 1.0.1 and removed in 0.13.2. 
...
here, originally written for Bitcoin but can also be used for Tyzen:
