...
This document provides guidelines for internationalization of the Tyzen Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `tyzen_en.ts` remains unchanged.
