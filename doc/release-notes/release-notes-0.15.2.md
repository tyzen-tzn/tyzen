Tyzen Core version *0.15.2* is now available from:

  <https://tyzencore.org/bin/tyzen-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in tyzen-tx (TheBlueMatt)
