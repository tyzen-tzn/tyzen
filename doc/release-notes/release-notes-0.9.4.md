Tyzen Core version 0.9.4 is now available from:

  https://tyzen.org/bin/0.9.4/
...
this update is incompatible with the Tyzen system and could lead to consensus
forks.

Tyzen Core released binaries from https://tyzen.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~tyzen/+archive/ubuntu/tyzen
- A third-party or self-compiled Tyzen Core

upgrade to Tyzen Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
