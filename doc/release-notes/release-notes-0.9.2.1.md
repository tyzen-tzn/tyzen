Tyzen Core version 0.9.2.1 is now available from:

  https://tyzen.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 TZN to 0.01 TZN
...
- Fix "Start tyzen on system login"
