Tyzen-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/tyzen/files/Tyzen/tyzen-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Tyzen
...
New/changed settings (command-line or tyzen.conf file)
--------------------------------------------------------
