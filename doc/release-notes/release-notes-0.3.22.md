Download URL: https://sourceforge.net/projects/tyzen/files/Tyzen/tyzen-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 TZN fee schedule (users still pay 0.01 TZN per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #tyzen00 - #tyzen99
