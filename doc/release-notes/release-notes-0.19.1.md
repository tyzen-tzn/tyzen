...
Tyzen Core version 0.19.1 is now available from:

  <https://tyzencore.org/bin/tyzen-core-0.19.1/>
...
From Tyzen Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Tyzen Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Tyzen Core does not yet change appearance when
...
- #17488 fix "tyzend already running" warnings on macOS (fanquake)
