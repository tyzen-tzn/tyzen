Tyzen Core version 0.13.2 is now available from:

  <https://tyzen.org/bin/tyzen-core-0.13.2/>
...
- #8908 `4a974b2` Update tyzen-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow tyzen-tx to create v2 transactions (btcdrak)
