Tyzen version 0.5.4 is now available for download at:
http://sourceforge.net/projects/tyzen/files/Tyzen/tyzen-0.5.4/
...
http://gitorious.org/tyzen/tyzend-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Tyzen-Qt notifications under Growl 1.3.
Increase required age of Tyzen-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxTyzen properly when installing Tyzen-Qt over it. (Windows)
