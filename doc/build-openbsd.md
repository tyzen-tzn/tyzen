...
This guide describes how to build tyzend, command-line utilities, and GUI on OpenBSD.
...
### 2. Clone Tyzen Repo
Clone the Tyzen Core repository to a directory. All build scripts and commands will run from this directory.
``` bash
...
Tyzen Core includes a GUI built with the cross-platform Qt Framework. To compile the GUI, Qt 5 is required.
...
(see issue [#6658](https://github.com/tyzen/tyzen/issues/6658)).
